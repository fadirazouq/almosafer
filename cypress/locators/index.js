export default {
  searchPage: {
    ...
    currencySelector: '[data-testid=Header__CurrencySelector]',
    currencyAED:'[data-testid=CurrencySelection__AED]',
    firstLocationOption:'[data-testid=AutoCompleteResultItem0]',
    flightNavbarTab:'[data-testid="Header__FlightsNavigationTab"]',
    getLabel: (value) => `[aria-label="${value}"]`,
    getValue: (value) => `[value*="${value}"]`,
    hotelNavbarTab:'[data-testid="Header__HotelsNavigationTab"]',
    hotelTab: '#uncontrolled-tab-example-tab-hotels',
